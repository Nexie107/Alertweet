...
function dates_EssoneSO(tweet){ //retrieve every date formatted as DD/MM or MM/DD similar
...
function time_EssoneSO(tweet){ //retrieve every time formatted as [HH]h[mm] or [HH]:[mm] or similar to these two
