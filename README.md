...
6. Créer les macros:
    ...
    * :star: Créer un fichier "Main.gs" et y copier-coller le contenu de [Main.gs](code/Main.gs)
...
6. Create the macros:
    ...
    * :star: Create a file "Main.gs" and copy-paste the content of [Main.gs](code/Main.gs)
